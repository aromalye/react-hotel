...
function StaffDetails() {
    ...
    const deleteData = (id) => {
        ...
        axios.delete(`http://localhost:8080/hotelbooking/deletex/${id}`)
        .then((res) => {
            ...
            <Modal show={show} onHide={handleClose} animation={false}>
                ...
                <Modal.Body>
                    <Form.Group value={editDatas.staffName} onChange={(e) => editHandle(e) } className="mb-3" controlId="staffName">
                        <Form.Control defaultValue={inputDatas.staffName} type="text" placeholder="Manager Name" />
                    </Form.Group>
                    ...
                    <Form.Group value={editDatas.idProofType} defaultValue={inputDatas.idProofType} onChange={(e) => editHandle(e) } className="mb-3" controlId="idProofType">
                                    <Form.Select className='my-3' aria-label="Default select example">
                                    <option value="">ID ProofType</option>
                                    <option value="adhaar">Adhaar </option>
                                    <option value="pan">PAN </option>
                    ...
                    <Form.Group value={editDatas.idProofNo} defaultValue={inputDatas.idProofNo} onChange={(e) => editHandle(e) } className="mb-3" controlId="idProofNo">
